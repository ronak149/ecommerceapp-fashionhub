  ...
  const prices = [
    ...
    return(
      ...
      <span className='float-end'><button class="btn btn-outline-dark d-lg-none fw-semibold" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasResponsive" aria-controls="offcanvasResponsive"> Filter Items &nbsp; <i class="bi bi-sliders "></i></button></span>  
        ...
        <p className="border-bottom pb-2"><Link className="text-secondary text-decoration-none " to="/search?gender=Men"><input class="form-check-input" type="checkbox" /> Men's</Link></p>
        <p className="border-bottom pb-2"><Link className="text-secondary text-decoration-none" to="/search?gender=Women&type=sale"><input class="form-check-input" type="checkbox" /> On Sale</Link></p>

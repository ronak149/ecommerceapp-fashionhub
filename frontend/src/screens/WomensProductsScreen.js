                ...
                <div className="col-md-3 p-2 pt-0" >
                  <div className="card shadow p-0 cardWidth" >
                    ...
                    <div className="card-body">
                      ...
                      <Link to="/search?&gender=Women" className="text-decoration-none"><p className="card-text">Shop now</p></Link>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-md-3 p-2 pt-0" >
                  <div className="card shadow p-0 cardWidth" >
                    ...
                    <div className="card-body">
                      ...
                      <Link to="/search?&gender=Women&category=T-Shirts" className="text-decoration-none"><p className="card-text">Shop now</p></Link>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-md-3 p-2 pt-0" >
                  <div className="card shadow p-0 cardWidth" >
                    ...
                    <div className="card-body">
                      ...
                      <Link to="/search?&gender=Women&category=Footwear" className="text-decoration-none"><p className="card-text">Shop now</p></Link>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-md-3 p-2 pt-0" >
                  <div className="card shadow p-0 cardWidth" >
                    ...
                    <div className="card-body">
                      ...
                      <Link to="/search?&gender=Women&category=Accessories" className="text-decoration-none"><p className="card-text">Shop now</p></Link>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-md-6 p-2">
                  <div className="card shadow p-0" >
                    ...
                    <div className="card-body">
                      ...
                      <Link to="/search?&gender=Women&collection=Fall" className="text-decoration-none"><p className="card-text">Shop now</p></Link>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="col-12 mt-2" style={{ maxHeight: '40vh' }}>
                    <div className="row text-center" >
                      ...
                      <div className="col-3 mx-auto mb-3 text-start">
                        ...
                        <Link to="/search?&gender=Women&category=T-Shirts" className="category-links d-block mb-2">T-Shirts</Link>
                        <Link to="/search?&gender=Women&category=Hoodies" className="category-links d-block mb-2">Hoodies</Link>
                        <Link to="/search?&gender=Women&category=Pants" className="category-links d-block mb-2">Pants</Link>
                        <Link to="/search?&gender=Women&category=Shorts" className="category-links d-block mb-2">Shorts</Link>
                      </div>

                      <div className="col-3 mx-auto mb-3 text-start">
                        <h6 className="fw-semibold mb-2 ">Accessories</h6>
                        <Link to="/search?&gender=Women&category=Accessories" className="category-links d-block mb-2">Caps</Link>
                        <Link to="/search?&gender=Women&category=Accessories" className="category-links d-block mb-2">Belts</Link>
                        <Link to="/search?&gender=Women&category=Accessories" className="category-links d-block mb-2">Beanie</Link>
                        <Link to="/search?&gender=Women&category=Accessories" className="category-links d-block mb-2">Bags</Link>
                      </div>

                      <div className="col-3 mx-auto mb-3 text-start">
                        <h6 className="fw-semibold mb-2 ">Footwear</h6>
                        <Link to="/search?&gender=Women&category=Footwear" className="category-links d-block mb-2">Shoes</Link>
                        <Link to="/search?&gender=Women&category=Footwear" className="category-links d-block mb-2">Sandals</Link>
                        <Link to="/search?&gender=Women&category=Footwear" className="category-links d-block mb-2">Slippers</Link>
                      </div>
                    </div>
                  </div>
                </div>
